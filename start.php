...
function tidypics_init() {
	...
	elgg_register_js('jquery.pagination', 'mod/tidypics/vendors/pagination/jquery.pagination.js', 'footer');
	elgg_register_css("pagination", "mod/tidypics/vendors/pagination/pagination.css");
